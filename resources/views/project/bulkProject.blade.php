...
axios(fileInsert, {
    ...
    function repeatForm()
    {
        ...
        div.innerHTML+="<div class='row input-field'><div class='col s4'><p><label><input type='checkbox' id='aurora_design' onchange='getDesignPrice('aurora_design',{{$project_id}},1)' name='aurora_design'/><span>Aurora Design</span></label></p></div><div class='col s4'><p><label><input type='checkbox' id='structural_load' onchange='getDesignPrice('structural_load',{{$project_id}},1)' name='structural_load'/> <span>Structural Load Letter and Calculations</span></label></p></div><div class='col s4'><p><label><input type='checkbox' id='pe_stamping' onchange='getDesignPrice('pe_stamping',{{$project_id}},1)' name='pe_stamping'/><span>PE Stamping</span></label></p></div></div>";
    
        div.innerHTML+="<div class='row input-field'><div class='col s4'><p><label><input type='checkbox' id='pe_stamping' onchange='getDesignPrice('pe_stamping',{{$project_id}},1)' name='Electrical Load Calculations'/><span>Electrical Load Calculations</span></label></p></div><div class='col s4'><p><label><input type='checkbox' id='Engineering Permit Package' onchange='getDesignPrice('Engineering Permit Package',{{$project_id}},1)' name='Engineering Permit Package'/> <span>Engineering Permit Package</span></label></p></div></div>";
